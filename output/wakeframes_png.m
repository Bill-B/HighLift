%=========================================================================%
%simple tool that creates a a set of pngs for latex gif makers... this
%hasnt been updated for the new quicker "patch" method. See wakeframes_gif
%
...
%     view([-23 16])
    ...
    cdir = pwd;
    cd ('C:\Users\Bill\Documents\ryEng\MASc\SciTech2016\presentation\figures\gifs\trappainters\');
    % set(h,'PaperPositionMode', 'auto')
    name = strcat('trap_',num2str(step-1));
    print(name,'-dpng')
    cd (cdir);
    
    set(h,'renderer','opengl');
    cd ('C:\Users\Bill\Documents\ryEng\MASc\SciTech2016\presentation\figures\gifs\trapopengl\');
    print(name,'-dpng')
    cd (cdir);
